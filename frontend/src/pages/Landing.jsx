    ...
    const getTriangles = () => {
      ...
      for (let i = 0; i < points.length; i++) {
        for (let j = i + 1; j < points.length; j++) {
          ...
          if (Math.sqrt(dx * dx + dy * dy) < canvas.width / (COLS - 1) * 1.6) {
            tris.push([i, j])
          }
        }
      }
...
function BrandIntroSection({ onBrandLocked }) {
  ...
  useEffect(() => {
    return scrollY.on('change', (y) => {
      ...
      if (y > h * 0.55 && phaseRef.current === 'interactive') {
      ...
      if (y < h * 0.2 && phaseRef.current === 'locked') {
        setPhaseSync('interactive')
        onBrandLocked?.(false)
      }
    })
  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" style={{
        position: 'absolute', inset: 0,
        background: 'radial-gradient(ellipse 60% 55% at 50% 50%, transparent 30%, var(--bg-primary) 80%)',
      ...
      <div aria-hidden="true" style={{
        ...
        background: `radial-gradient(circle, rgba(${CANVAS_ACCENT_RGB},0.07) 0%, transparent 60%)`,
        pointerEvents: 'none', zIndex: 1,
      }} />
  ...
  return (
    <Link
      ...
      style={{
        ...
        border: `1px solid ${hovered ? 'var(--accent-primary)' : 'rgba(255,255,255,0.16)'}`,
        ...
        transition: [
          ...
          'color 220ms cubic-bezier(0.25,0.1,0.25,1)',
        ].join(', '),
      }}
    >
      Login
      ...
      <div style={{
          ...
          {[
            ...
            <div key={s.l} style={{
              ...
              <div style={{
                ...
                fontWeight: '600', color: 'var(--accent-primary)', marginBottom: '4px',
              }}>{s.v}</div>
              <div style={{
        ...
        <div style={{ marginBottom: '20px' }}>
          <div style={{
            ...
            <span style={{ fontSize: '12px', color: 'var(--accent-primary)', fontFamily: 'Satoshi, sans-serif' }}>
              78%
            </span>
          </div>
    ...
    <section id="features" ref={ref} style={{
      ...
      >
        <motion.p variants={fadeUp} style={{
          ...
          color: 'var(--accent-primary)', marginBottom: '16px',
        }}>
          Core Capabilities
        </motion.p>
...
function HowItWorksSection() {
  ...
  // Step dot positions — evenly spaced, properly centered on the track
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* Progress track container — flex-col to stretch full height of step texts */}
            <div style={{
              display: 'flex',
              flexDirection: 'column',
              alignItems: 'center',
              flexShrink: 0,
              width: '20px',
              // match the step text column height
              alignSelf: 'stretch',
            }}>
              {/* Vertical track — full height of this container */}
              <div style={{
                position: 'relative',
                width: '2px',
                flex: 1,
                ...
                {/* Step dots — absolutely placed at 0%, 50%, 100% of track height */}
                {HOW_STEPS.map((step, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      style={{
                        position: 'absolute',
                        // Center on track: left = 50%, translateX = -50%
                        // top: 0% / 50% / 100% with translateY centering
                        left: '50%',
                        top: DOT_POSITIONS[i],
                        transform: 'translate(-50%, -50%)',
            ...
            {/* Step texts — always visible, faded unless active */}
            <div style={{
              display: 'flex',
              flexDirection: 'column',
              flex: 1,
              // Space items so they align with 0%, 50%, 100% of the track
              justifyContent: 'space-between',
            }}>
              {HOW_STEPS.map((step, i) => {
        ...
        {[
          ...
          <div key={r.label} style={{ marginBottom: '14px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
              ...
              <span style={{ fontFamily: 'Satoshi, sans-serif', fontSize: '13px', color: 'var(--accent-primary)', fontWeight: '600' }}>{r.score}</span>
            </div>
            <div className="progress-track">
              <motion.div
                className="progress-fill"
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div style={{
              ...
              backgroundColor: 'var(--accent-soft)', flexShrink: 0,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}>
              <span style={{ fontFamily: 'Satoshi, sans-serif', fontSize: '11px', fontWeight: '600', color: 'var(--accent-primary)' }}>
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
        ...
        <div style={{
          ...
          background: `linear-gradient(135deg, rgba(${CANVAS_ACCENT_RGB},0.2), rgba(${CANVAS_ACCENT_RGB},0.06))`,
          border: `1px solid rgba(${CANVAS_ACCENT_RGB},0.2)`,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          flexShrink: 0,
        }}>
          <span style={{
        ...
        <div>
          ...
          <div style={{
            fontFamily: 'Satoshi, sans-serif', fontSize: '13px',
            lineHeight: '20px', color: 'var(--accent-primary)',
            opacity: 0.7,
          }}>{role}</div>
        </div>
      </div>
