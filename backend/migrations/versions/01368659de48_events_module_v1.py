...
Revision ID: 01368659de48
Revises: 1a0df92c997d
Create Date: 2026-02-19 15:25:42.462538
...
revision = '01368659de48'
down_revision = '1a0df92c997d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_column('events', 'current_participants', if_exists=True)
